...
CITY_OF_FRISCO_SPECIFIC_INSTRUCTIONS = """

CITY OF FRISCO SPECIFIC INSTRUCTIONS:

This template applies to bills with "City of Frisco" or "Frisco" text.

SECTION 1 - PROVIDER INFORMATION:
**CRITICAL**: Extract City of Frisco provider information
- Provider Name: "City of Frisco"
...
CITY_OF_FRISCO_JSON_FORMAT = """

Return in this exact JSON format. ALL FIELDS MUST BE INCLUDED for City of Frisco bills:
{
  "provider_name": "City of Frisco",
...
CITY_OF_FRISCO_PROMPT = f"""{BASE_EXTRACTION_FIELDS}
