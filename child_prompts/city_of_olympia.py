...
CITY_OF_OLYMPIA_SPECIFIC_INSTRUCTIONS = """

CITY OF OLYMPIA SPECIFIC INSTRUCTIONS:

This template applies to bills with "City of Olympia" or "Olympia" text.

SECTION 1 - PROVIDER INFORMATION:
**CRITICAL**: Extract City of Olympia provider information
- Provider Name: "City of Olympia"
...
CITY_OF_OLYMPIA_JSON_FORMAT = """

Return in this exact JSON format. ALL FIELDS MUST BE INCLUDED for City of Olympia bills:
{
  "provider_name": "City of Olympia",
...
CITY_OF_OLYMPIA_PROMPT = f"""{BASE_EXTRACTION_FIELDS}
