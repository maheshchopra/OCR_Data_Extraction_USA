...
ALDERWOOD_WATER_WASTEWATER_SPECIFIC_INSTRUCTIONS = """

ALDERWOOD WATER AND WASTEWATER SPECIFIC INSTRUCTIONS:

This template applies to bills with "Alderwood Water" or "Alderwood Water and Wastewater" text.

SECTION 1 - PROVIDER INFORMATION:
**CRITICAL**: Extract Alderwood Water and Wastewater provider information
- Provider Name: "Alderwood Water and Wastewater" or "Alderwood Water"
...
- Account Number: Look for "Account Number", "Account No", or similar label
  * Extract digits only
- Account Type: Typically "Water & Wastewater" or "Water & Sewer"
...
- For EACH meter on the bill, extract:
  ...
  3. Service Type: The service this meter measures (Water, Wastewater, Sewer, etc.)
...
- Extract ALL services (Water, Wastewater, Sewer, etc.) with complete details
...
SPECIAL NOTES FOR ALDERWOOD WATER AND WASTEWATER BILLS:
- Alderwood bills typically provide both Water and Wastewater services
- Meter information is critical - extract all meter details
- Service charges may be usage-based (with rates and consumption) or flat fees
...
ALDERWOOD_WATER_WASTEWATER_JSON_FORMAT = """

Return in this exact JSON format. ALL FIELDS MUST BE INCLUDED for Alderwood Water and Wastewater bills:
{
  "provider_name": "Alderwood Water and Wastewater",
  ...
  "meters": [
    {
      ...
      "service_type": "service_type_like_Water_or_Wastewater",
...
ALDERWOOD_WATER_WASTEWATER_PROMPT = f"""{BASE_EXTRACTION_FIELDS}
