...
GRAYS_HARBOR_PUD_SPECIFIC_INSTRUCTIONS = """

GRAYS HARBOR PUD SPECIFIC INSTRUCTIONS:

This template applies to bills with "Grays Harbor PUD" or "Grays Harbor Public Utility District" text.

SECTION 1 - PROVIDER INFORMATION:
**CRITICAL**: Extract Grays Harbor PUD provider information
- Provider Name: "Grays Harbor PUD" or "Grays Harbor Public Utility District"
...
- Account Number: Look for "Account Number", "Account No", or similar label
  * Extract digits only
- Account Type: Typically "Electric" or "Water & Electric" or similar service bundle
...
- For EACH meter on the bill, extract:
  ...
  3. Service Type: The service this meter measures (Electric, Water, etc.)
  ...
  10. Unit of Measurement (UOM): The unit (kWh, CCF, gallons, etc.)
...
- Extract ALL services (Electric, Water, etc.) with complete details
- For EACH service, extract:
  ...
  - Line Item Charges: Extract EVERY line item for this service
    * Each line item must include:
      ...
      - UOM: Unit of measurement (kWh, CCF, gallons, etc.)
...
GRAYS_HARBOR_PUD_JSON_FORMAT = """

Return in this exact JSON format. ALL FIELDS MUST BE INCLUDED for Grays Harbor PUD bills:
{
  "provider_name": "Grays Harbor PUD",
  ...
  "account_number": "numeric_digits_only_or_null",
  "account_type": "Electric_or_Water_&_Electric_or_null",
  ...
  "meters": [
    {
      ...
      "service_type": "service_type_like_Electric_or_Water",
      ...
      "uom": "unit_like_kWh_CCF_or_gallons",
...
GRAYS_HARBOR_PUD_PROMPT = f"""{BASE_EXTRACTION_FIELDS}
