...
CITY_OF_AUBURN_SPECIFIC_INSTRUCTIONS = """

CITY OF AUBURN SPECIFIC INSTRUCTIONS:

This template applies to bills with "City of Auburn" or "Auburn" text.

SECTION 1 - PROVIDER INFORMATION:
**CRITICAL**: Extract City of Auburn provider information
- Provider Name: "City of Auburn"
...
SPECIAL NOTES FOR CITY OF AUBURN BILLS:
- Auburn bills typically provide both Water and Sewer services
...
CITY_OF_AUBURN_JSON_FORMAT = """

Return in this exact JSON format. ALL FIELDS MUST BE INCLUDED for City of Auburn bills:
{
  "provider_name": "City of Auburn",
...
CITY_OF_AUBURN_PROMPT = f"""{BASE_EXTRACTION_FIELDS}
