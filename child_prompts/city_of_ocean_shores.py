...
CITY_OF_OCEAN_SHORES_SPECIFIC_INSTRUCTIONS = """

CITY OF OCEAN SHORES SPECIFIC INSTRUCTIONS:

This template applies to bills with "City of Ocean Shores" or "Ocean Shores" text.

SECTION 1 - PROVIDER INFORMATION:
**CRITICAL**: Extract City of Ocean Shores provider information
- Provider Name: "City of Ocean Shores"
...
CITY_OF_OCEAN_SHORES_JSON_FORMAT = """

Return in this exact JSON format. ALL FIELDS MUST BE INCLUDED for City of Ocean Shores bills:
{
  "provider_name": "City of Ocean Shores",
...
CITY_OF_OCEAN_SHORES_PROMPT = f"""{BASE_EXTRACTION_FIELDS}
