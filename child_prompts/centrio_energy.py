...
CENTRIO_ENERGY_SEATTLE_SPECIFIC_INSTRUCTIONS = """

CENTRIO ENERGY SEATTLE SPECIFIC INSTRUCTIONS:

This template applies to bills with "CenTrio Energy Seattle" or "CenTrio" text.

SECTION 1 - PROVIDER INFORMATION:
**CRITICAL**: Extract CenTrio Energy Seattle provider information
- Provider Name: "CenTrio Energy Seattle" or "CenTrio"
...
- Provider Customer Service Phone: Look for customer service phone number
  * Common format: "(XXX) XXX-XXXX" or "XXX.XXX.XXXX" or "1-XXX-XXX-XXXX"
...
- Account Number: Look for "Account Number", "Account No", or similar label
  * Extract digits only
- Account Type: Typically "District Energy", "Energy", "Steam", "Hot Water", or "Cooling"
...
- Service Address: Physical location where energy services are provided
...
- CenTrio bills may organize charges BY METER NUMBER
- Each meter may have its own section with meter details and associated charges
- For EACH meter on the bill, extract:
  ...
  3. Service Type: The service this meter measures (Steam, Hot Water, Cooling, Energy, etc.)
  4. Read Date: When the meter was read
  5. Start Date: Beginning of billing period for this meter
  6. End Date: End of billing period for this meter
  7. Previous Reading: Meter reading at start of period
  8. Previous Reading Type: How previous reading was obtained ("Actual", "Estimated", "Customer")
  9. Current Reading: Meter reading at end of period
  10. Current Reading Type: How current reading was obtained ("Actual", "Estimated", "Customer")
  11. Usage: Consumption amount (numeric value only)
     * May be in MMBtu (million BTUs), therms, gallons, or other units
  12. Unit of Measurement (UOM): The unit (MMBtu, therms, gallons, etc.)
  13. Multiplier: Any multiplier applied to calculate actual usage
  ...
  14. Read Type: How reading was obtained ("Actual", "Estimated", "Customer")
...
- Extract ALL services (Steam, Hot Water, Cooling, Energy, etc.) with complete details
- For EACH service, extract:
  - Service Name: The service type exactly as labeled on the bill
    * Common services: Steam Service, Hot Water Service, Cooling Service, Energy Service, etc.
  ...
  - Line Item Charges: Extract EVERY line item for this service
    * Each line item must include:
      - Category: The charge category/description
        * Examples: Base Charge, Usage Charge, Demand Charge, Service Charge, etc.
      - Description: Detailed description (if different from category)
      - Rate: Rate per unit (if applicable)
        * May be per MMBtu, per therm, per gallon, etc.
      - Rate x Unit: The rate calculation (e.g., "150 MMBtu x $12.50")
      ...
      - UOM: Unit of measurement (MMBtu, therms, gallons, etc.)
...
- **IMPORTANT**: Group all meters/services of the same type together into ONE service entry if appropriate
...
SPECIAL NOTES FOR CENTRIO ENERGY SEATTLE BILLS:
- CenTrio provides district energy services (steam, hot water, cooling)
- Bills may be organized by meter number (similar to PSE Electric)
- Usage is typically measured in MMBtu (million BTUs), therms, or gallons
- Service charges may include base charges, usage charges, and demand charges
- All fields from field_names.txt must be extracted
...
- If bills have multiple meters, process EACH meter separately

"""

CENTRIO_ENERGY_SEATTLE_JSON_FORMAT = """

Return in this exact JSON format. ALL FIELDS MUST BE INCLUDED for CenTrio Energy Seattle bills:
{
  "provider_name": "CenTrio Energy Seattle",
  ...
  "meters": [
    {
      ...
      "service_type": "service_type_like_Steam_Hot_Water_or_Cooling",
      ...
      "uom": "unit_like_MMBtu_therms_or_gallons",
      ...
      "line_item_charges": [
        {
          ...
          "description": "detailed_description_or_null",
          "rate": "rate_per_unit_or_null",
          "rate_x_unit": "calculation_like_150_MMBtu_x_$12.50_or_null",
          "amount": "dollar_amount",
          "meter_number": "meter_id_or_null",
          "usage": "numeric_value_or_null",
          "uom": "unit_like_MMBtu_therms_or_gallons_or_null",
          "previous_reading": "reading_value_or_null",
          "previous_reading_type": "Actual_or_Estimated_or_null",
          "current_reading": "reading_value_or_null",
          "current_reading_type": "Actual_or_Estimated_or_null",
...
CENTRIO_ENERGY_SEATTLE_PROMPT = f"""{BASE_EXTRACTION_FIELDS}
