...
CITY_OF_LYNNWOOD_SPECIFIC_INSTRUCTIONS = """

CITY OF LYNNWOOD SPECIFIC INSTRUCTIONS:

This template applies to bills with "City of Lynnwood" or "Lynnwood" text.

SECTION 1 - PROVIDER INFORMATION:
**CRITICAL**: Extract City of Lynnwood provider information
- Provider Name: "City of Lynnwood"
...
CITY_OF_LYNNWOOD_JSON_FORMAT = """

Return in this exact JSON format. ALL FIELDS MUST BE INCLUDED for City of Lynnwood bills:
{
  "provider_name": "City of Lynnwood",
...
CITY_OF_LYNNWOOD_PROMPT = f"""{BASE_EXTRACTION_FIELDS}
