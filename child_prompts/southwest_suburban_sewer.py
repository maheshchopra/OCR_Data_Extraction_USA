...
SOUTHWEST_SUBURBAN_SEWER_DISTRICT_SPECIFIC_INSTRUCTIONS = """

SOUTHWEST SUBURBAN SEWER DISTRICT SPECIFIC INSTRUCTIONS:

This template applies to bills with "Southwest Suburban Sewer District" or "SWSSD" text.

SECTION 1 - PROVIDER INFORMATION:
**CRITICAL**: Extract Southwest Suburban Sewer District provider information
- Provider Name: "Southwest Suburban Sewer District"
...
- Extract ALL sewer services (Base Service, ERU charges, Flow charges, etc.) with complete details
- For EACH service, extract:
  ...
  - Line Item Charges: Extract EVERY line item for this service
    * Each line item must include:
      - Category: The charge category/description (e.g., "Base Charge", "Flow Charge")
      ...
      - Usage: Numeric usage (if applicable, e.g., ERUs, flow)
      - UOM: Unit of measurement (if applicable)
- **IMPORTANT**: Group all charges belonging to the same service into ONE service entry
...
SOUTHWEST_SUBURBAN_SEWER_DISTRICT_JSON_FORMAT = """

Return in this exact JSON format. ALL FIELDS MUST BE INCLUDED for Southwest Suburban Sewer District bills:
{
  "provider_name": "Southwest Suburban Sewer District",
...
SOUTHWEST_SUBURBAN_SEWER_DISTRICT_PROMPT = f"""{BASE_EXTRACTION_FIELDS}
