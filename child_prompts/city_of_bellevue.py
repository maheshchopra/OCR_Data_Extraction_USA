...
CITY_OF_BELLEVUE_SPECIFIC_INSTRUCTIONS = """

CITY OF BELLEVUE SPECIFIC INSTRUCTIONS:

This template applies to bills with "City of Bellevue" or "Bellevue" text.

SECTION 1 - PROVIDER INFORMATION:
**CRITICAL**: Extract City of Bellevue provider information
- Provider Name: "City of Bellevue"
...
CITY_OF_BELLEVUE_JSON_FORMAT = """

Return in this exact JSON format. ALL FIELDS MUST BE INCLUDED for City of Bellevue bills:
{
  "provider_name": "City of Bellevue",
...
CITY_OF_BELLEVUE_PROMPT = f"""{BASE_EXTRACTION_FIELDS}
