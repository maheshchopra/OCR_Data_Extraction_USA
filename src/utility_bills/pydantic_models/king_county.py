...
class LineItemCharge(BaseModel):
    """Individual charge line item from the DESCRIPTION section."""
...
class ChargesLevelData(BaseModel):
    """Charges information for the billing period."""
...
class KingCountyBillExtract(BaseModel):
    """Complete King County Wastewater Treatment Division bill extraction."""
