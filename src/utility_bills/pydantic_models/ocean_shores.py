...
class TotalAmountValidation(BaseModel):
    """Used to validate the sum of (previous balance, payments, adjustments, additional billing, and current charges)
    ...
    additional_billing: Optional[float] = None
...
class MeterLevelData(BaseModel):
    ...
    previous_reading_date: Optional[str] = None
    previous_reading: Optional[float] = None
    current_reading_date: Optional[str] = None
...
class OceanShoresBillExtract(BaseModel):
    """Complete City of Ocean Shores bill extraction."""
